    ...
    for file_name in tqdm(files_name_list, ascii=True):
        ...
        for article in articles_list:
            ...
            for message in messages_list:
                if message['push_userid'] not in push_ids_list_in_article and message['push_userid'] in push_ids and message['push_tag'] == "推":
...
if __name__ == "__main__":
    ...
    push_ids_json_name = 'push_id_times.json'
    ...
    with open('ptt_push_node_edge.json', 'w', encoding='utf-8') as fp:
